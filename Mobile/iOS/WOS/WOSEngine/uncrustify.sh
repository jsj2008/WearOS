...
#!/bin/bash
"/Applications/UniversalIndentGUI/indenters/uncrustify" -f "$file2indent" -c "/Users/lsuarez/Telemedicine/xcode/uncrustify_obj_c.cfg" -o indentoutput.tmp
...
#!/bin/bash
"/Applications/UniversalIndentGUI/indenters/uncrustify" -f "$1" -c "/Users/lsuarez/Telemedicine/xcode/uncrustify_obj_c.cfg" -o indentoutput.tmp
