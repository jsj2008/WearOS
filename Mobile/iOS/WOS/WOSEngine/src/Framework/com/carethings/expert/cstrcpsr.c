...
/************************************************************/
/* EnvLoadFromString: C access routine for the load command.*/
/*                    Loads from a string as oppose to      */
/*                    using a file.                         */
/************************************************************/
globle int EnvLoadFromString( void *theEnv, char *theString, int theMax)
{
	char*	theStrRouter = "*** load-from-string ***";
	int		noErrorsDetected;
	...
	noErrorsDetected = LoadConstructsFromLogicalName( theEnv, theStrRouter);
