...
@interface FIX_CATEGORY_BUG_ImageMetadataCategory
@end

@implementation FIX_CATEGORY_BUG_ImageMetadataCategory
@end
...
- (id)initFromAsset:(ALAsset *)asset {
    if ((self = [self init])) {
        NSDictionary *metadata = asset.defaultRepresentation.metadata;
...
- (NSString *)subjectLocation {
    NSDictionary *locDict = [self objectForKey:(NSString *) kCGImagePropertyExifDictionary];
    NSString *locationStr;

    if (locDict) {
        locationStr = [locDict objectForKey:(NSString *) kCGImagePropertyExifSubjectLocation];
    }
...
- (NSString *)artist {
    NSDictionary *locDict = [self objectForKey:(NSString *) kCGImagePropertyTIFFDictionary];
    NSString *artistStr;

    if (locDict) {
        artistStr = [locDict objectForKey:(NSString *) kCGImagePropertyTIFFArtist];
    }
...
- (NSString *)dateTime {
    ...
    if (locDict) {
        dateTimeStr = [locDict objectForKey:(NSString *) kCGImagePropertyTIFFDateTime];
    }
...
- (NSString *)description {
    ...
    if (locDict) {
        describeStr = [locDict objectForKey:(NSString *) kCGImagePropertyTIFFImageDescription];
    }
...
- (NSString *)userComment {
    ...
    if (locDict) {
        commentStr = [locDict objectForKey:(NSString *) kCGImagePropertyExifUserComment];
    }
...
- (void)setSubjectLocation:(NSString *)location {
    [EXIF_DICT setObject:location forKey:(NSString *) kCGImagePropertyExifSubjectLocation];
}

- (void)setArtist:(NSString *)artist {
    [TIFF_DICT setObject:artist forKey:(NSString *) kCGImagePropertyTIFFArtist];
}
...
- (void)setDateOriginal:(NSDate *)date {
    ...
    [EXIF_DICT setObject:now forKey:(NSString *) kCGImagePropertyExifDateTimeOriginal];
    [TIFF_DICT setObject:now forKey:(NSString *) kCGImagePropertyTIFFDateTime];
}
...
- (void)setDateDigitized:(NSDate *)date {
    ...
    [EXIF_DICT setObject:now forKey:(NSString *) kCGImagePropertyExifDateTimeDigitized];
}
