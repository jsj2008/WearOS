...
CURRENTCONFIG_DEVICE_DIR="../../lib/emPATH-iphoneos"
CURRENTCONFIG_SIMULATOR_DIR="../../lib/emPATH-iphonesimulator"
echo "Taking device build from: ../../lib/emPATH-iphoneos"
echo "Taking simulator build from: ../../lib/emPATH-iphonesimulator"
CREATING_UNIVERSAL_DIR="../../lib"
echo "...I will output a universal build to: ../../lib"
